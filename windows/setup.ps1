...
#   CUDA 12.9 runtime + cuBLAS + cuFFT, cuDNN 9
...
$need = "onnxruntime.dll", "onnxruntime_providers_shared.dll", "onnxruntime_providers_cuda.dll",
        ...
        "cudart64_12.dll", "cublas64_12.dll", "cublasLt64_12.dll", "cudnn64_9.dll", "cufft64_11.dll"
if (-not ($need | Where-Object { -not (Test-Path (Join-Path $root $_)) })) {
    Write-Host "runtime DLLs already present (offline bundle), nothing to download"
...
$pkgs = @(
    ...
    @{ name = "cufft";       url = "https://files.pythonhosted.org/packages/20/ee/29955203338515b940bd4f60ffdbc073428f25ef9bfbce44c9a066aedc5c/nvidia_cufft_cu12-11.4.1.4-py3-none-win_amd64.whl" },
